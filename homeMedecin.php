...
<div class="col-lg-2 col-md-2 col-sm-3 col-xs-12">
    ...
    <ul class="nav nav-pills nav-stacked" style="border-right:1px solid black">
        ...
        <li>
            <a href="listePatient1.php" data-toggle="collapse" data-target="#submenu-2"><i class="fa fa-user"></i> Patient <!--<i class="fa fa-fw fa-angle-down pull-right"></i>--></a>
        ...
        <li>
            <a href="listerdv1.php" data-toggle="collapse" data-target="#submenu-5"><i class="fa fa-calendar"></i> Rendez-vous </a>
        </li>
