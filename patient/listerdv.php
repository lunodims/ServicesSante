...
<div class="table-responsive" id="table_medecin">
    ...
    <table id="autoGeneratedID" role="grid" class="table table-striped table-bordered">
        ...
        <thead>
        <tr>
            <th id="prenom_m" role="gridcell" >Prénom médecin</th>
            <th id="nom_m" role="gridcell" >Nom médecin</th>
...
if (isset($_GET['email'])) {
    ...
    $sql_patient_id = "SELECT idPatient FROM patient WHERE email_p = :email";
    ...
    if ($patient) {
        ...
        $sql_rendezvous = "SELECT rdv.*, medecin.nom_m AS nom_medecin, medecin.prenom_m AS prenom_medecin 
                   FROM rendezvous AS rdv 
                   INNER JOIN medecin ON rdv.idMedecin = medecin.idMedecin 
                   WHERE rdv.idPatient = :patient_id";
...
$rendezvous = $stmt->fetchAll();
        ...
        foreach ($rendezvous as $rdv) {
            echo "<tr>";
            echo "<td id='prenom_m' role='gridcell'>" . $rdv['prenom_medecin'] . "</td>";
            echo "<td id='nom_m' role='gridcell'>" . $rdv['nom_medecin'] . "</td>";
...
?>
            ...
            <tr>
                <td id="nom_m" role="gridcell"><?php echo $donne['prenom_m'];?></td>
                <td id="prenom_m" role="gridcell"><?php echo $donne['nom_m'];?></td>
