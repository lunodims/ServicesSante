...
if ($insert == 'Valider') {
    ...
    try {
        ...
        $insert = $connexionDB->prepare("INSERT INTO infirmier(nom_i, prenom_i, adresse_i, numTel_i, specialite_i) VALUES (?, ?, ?, ?, ?)");
        $insert->execute([$nom, $prenom, $adresse, $numTel, $specialite]);
